...
class DataProvider:
    ...
    def get_x_and_y(self, artists):
        ...
        for artist in artists:
            x.append([avg_playtime for avg_playtime
    ...
    def _get_raw_data(self):
        ...
        data = sessions.merge(tracks[['id', 'id_artist', 'duration_ms']],
                              left_on='track_id',
                              right_on='id',
                              how='left')
        data = data.merge(artists[['id', 'name']],
                          left_on='id_artist',
                          right_on='id',
                          how='left')
        self._raw_data = data
    ...
    def _approximate_playtime(self, data):
        play_playtime = data[data['event_type'] == 'PLAY'] \
          .groupby('weeks_ordered')['duration_ms'].sum() * MS_TO_MIN
    ...
    def _preprocess(self):
        ...
        for artist in self._all_artists:
            if len(data[data['name'] == artist]
                   ['weeks_ordered'].unique()) == 12:
